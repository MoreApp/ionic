...
function keyboardBrowserFocusIn(e) {
  if( !e.target || e.target.getAttribute('data-reject-keyboard') || !ionic.tap.isTextInput(e.target) || ionic.tap.isDateInput(e.target) || !keyboardIsWithinScroll(e.target) ) return;
...
function keyboardShow(element, elementTop, elementBottom, viewportHeight, keyboardHeight) {
  ...
  if (ionic.Platform.platform() == 'win32nt') {
